...
public class CopperItems {
    ...
    public static final Supplier<Item> COPPER_RAIL = registerBlockItem("copper_rail", CopperBlocks.COPPER_RAIL);
    public static final Supplier<Item> COPPER_ACTIVATOR_RAIL = registerBlockItem("copper_activator_rail", CopperBlocks.COPPER_ACTIVATOR_RAIL);
    public static final Supplier<Item> COPPER_DETECTOR_RAIL = registerBlockItem("copper_detector_rail", CopperBlocks.COPPER_DETECTOR_RAIL);
    public static final Supplier<Item> COPPER_POWERED_RAIL = registerBlockItem("copper_powered_rail", CopperBlocks.COPPER_POWERED_RAIL);
    ...
    public static final Supplier<Item> HOPPER_COPPER_MINECART = register("hopper_copper_minecart", properties -> new MinecartItem(ModEntityTypes.HOPPER_COPPER_MINECART.get(), properties), new Item.Properties().stacksTo(1));
    public static final Supplier<Item> COPPER_HOPPER_COPPER_MINECART = register("copper_hopper_copper_minecart", properties -> new MinecartItem(ModEntityTypes.COPPER_HOPPER_COPPER_MINECART.get(), properties), new Item.Properties().stacksTo(1));
    ...
    public static final Supplier<Item> COPPER_LANTERN = registerBlockItem("copper_lantern", CopperBlocks.COPPER_LANTERN);
    public static final Supplier<Item> COPPER_SOUL_LANTERN = registerBlockItem("copper_soul_lantern", CopperBlocks.COPPER_SOUL_LANTERN);
    public static final Supplier<Item> COPPER_NUGGET = register("copper_nugget", Item::new);
    public static final Supplier<Item> COPPER_CHAIN = registerBlockItem("copper_chain", CopperBlocks.COPPER_CHAIN);
    ...
    public static final Supplier<Item> COPPER_CAULDRON = registerBlockItem("copper_cauldron", CopperBlocks.COPPER_CAULDRON);
    ...
    public static final Supplier<Item> COPPER_BARS = registerBlockItem("copper_bars", CopperBlocks.COPPER_BARS);
    public static final Supplier<Item> COPPER_HOPPER = registerBlockItem("copper_hopper", CopperBlocks.COPPER_HOPPER, new Item.Properties().component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
